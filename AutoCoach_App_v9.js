...
export default function App() {
  ...
  function completeOnboarding() {
    ...
    AsyncStorage.setItem('autocoach_onboarding_complete', 'true');
  }

  function agreeToDisclaimer() {
    setDisclaimerAgreed(true);
    AsyncStorage.setItem('autocoach_disclaimer_agreed', 'true');
  }
